        ...
        <div className="footer-content grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 md:gap-12">
          ...
          <div className="sm:col-span-2 lg:col-span-1">
            ...
            <div className="flex flex-wrap gap-2 sm:gap-3">
              ...
              <a 
                href="#" 
                className="relative px-2 py-1 sm:px-3 sm:py-1.5 flex items-center text-xs sm:text-sm font-semibold cursor-pointer border border-[#E1306C] rounded-full overflow-hidden text-[#E1306C] transition-colors duration-300 ease-out hover:text-white hover:border-[#E1306C] group"
              ...
              >
                ...
                <svg 
                  className="relative z-10 w-4 h-4 sm:w-5 sm:h-5 fill-[#E1306C] group-hover:fill-current transition-colors flex-shrink-0" 
                  viewBox="0 0 24 24" 
                ...
                <span className="relative z-10 ml-1.5 mr-1 sm:mx-2 whitespace-nowrap">IG</span>
              </a>
              
              {/* Facebook */}
              <a 
                href="#" 
                className="relative px-2 py-1 sm:px-3 sm:py-1.5 flex items-center text-xs sm:text-sm font-semibold cursor-pointer border border-[#0163E0] rounded-full overflow-hidden text-[#0163E0] transition-colors duration-300 ease-out hover:text-white hover:border-[#0163E0] group"
                aria-label="Facebook"
              >
                ...
                <svg 
                  className="relative z-10 w-4 h-4 sm:w-5 sm:h-5 fill-[#0163E0] group-hover:fill-current transition-colors flex-shrink-0" 
                  viewBox="0 0 24 24" 
                  xmlns="http://www.w3.org/2000/svg"
                >
                  <path d="M12 2.03998C6.5 2.03998 2 6.52998 2 12.06C2 17.06 5.66 21.21 10.44 21.96V14.96H7.9V12.06H10.44V9.84998C10.44 7.33998 11.93 5.95998 14.22 5.95998C15.31 5.95998 16.45 6.14998 16.45 6.14998V8.61998H15.19C13.95 8.61998 13.56 9.38998 13.56 10.18V12.06H16.34L15.89 14.96H13.56V21.96C15.9164 21.5878 18.0622 20.3855 19.6099 18.57C21.1576 16.7546 22.0054 14.4456 22 12.06C22 6.52998 17.5 2.03998 12 2.03998Z" />
                </svg>
                <span className="relative z-10 ml-1.5 mr-1 sm:mx-2 whitespace-nowrap">FB</span>
              </a>
              ...
              <a 
                ...
                className="relative px-2 py-1 sm:px-3 sm:py-1.5 flex items-center text-xs sm:text-sm font-semibold cursor-pointer border border-[#25D366] rounded-full overflow-hidden text-[#25D366] transition-colors duration-300 ease-out hover:text-white hover:border-[#25D366] group"
                aria-label="WhatsApp"
              >
                ...
                <svg 
                  className="relative z-10 w-4 h-4 sm:w-5 sm:h-5 fill-[#25D366] group-hover:fill-current transition-colors flex-shrink-0" 
                  viewBox="0 0 24 24" 
                  xmlns="http://www.w3.org/2000/svg"
                >
                ...
                <span className="relative z-10 ml-1.5 mr-1 sm:mx-2 whitespace-nowrap">WA</span>
              </a>
            </div>
          </div>
